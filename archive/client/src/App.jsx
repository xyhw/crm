  ...
  return (
    <div className="app-container">
      <Routes>
        ...
        <Route path="/my-opportunities" element={<RequireAuth><Suspense fallback={<PageLoading />}><MyOpportunities /></Suspense></RequireAuth>} />
        ...
        <Route path="/announcement/:id" element={<RequireAuth><Suspense fallback={<PageLoading />}><AnnouncementDetail /></Suspense></RequireAuth>} />
      </Routes>
      <TabBar />
    </div>
  );

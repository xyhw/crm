<template>
  <view class="admin-list-page">
    ...
    <view class="filter-bar">
      <SearchBar v-model="keywordInput" placeholder="搜索标签名称" @search="onSearch" @clear="onClear" />
    </view>
...
async function save() {
  ...
  try {
    if (editItem.value.id) {
      await adminApi.updateTag(editItem.value.id, body);
    } else {
